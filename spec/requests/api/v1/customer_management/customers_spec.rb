...
RSpec.describe "Api::V1::CustomerManagement::Customers", type: :request do
  ...
  describe "GET /index" do
    it 'returns a successful response' do
      get "/api/v1/customer_management/customers", headers: valid_header
      expect(response).to have_http_status(:success)
    end

    it 'returns a successful response for searching a name' do
      get "/api/v1/customer_management/customers",params: { search: 'JohnDoe' } ,headers: valid_header
      expect(response).to have_http_status(:success)
    end
  ...
  describe "POST /create" do
    it 'returns a successful response' do
      get "/api/v1/customer_management/customers",params: params ,headers: valid_header
      expect(response).to have_http_status(:success)
    end
  end
  ...
  describe "GET /update" do
    it 'returns a successful response' do
      get "/api/v1/customer_management/customers/#{customer.id}", headers: valid_header
      expect(response).to have_http_status(:success)
    end
  end
  ...
  describe "PUT /update" do
    it 'returns a successful response' do
      put "/api/v1/customer_management/customers/#{customer.id}",params: edit_params ,headers: valid_header
      expect(response).to have_http_status(:success)
    end
  end
